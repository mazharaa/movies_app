...
import 'package:movies_app/application/auth/auth_cubit.dart' as _i141;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    gh.lazySingleton<_i794.SecureStorageController>(
        () => _i794.SecureStorageController());
    gh.factory<_i361.Dio>(() => registerModule.dio(gh<_i415.Env>()));
    gh.lazySingleton<_i725.ApiHelper>(() => _i725.ApiHelper(gh<_i361.Dio>()));
    gh.factory<_i969.AuthDataSources>(() => _i969.AuthDataSources(
          gh<_i725.ApiHelper>(),
          gh<_i794.SecureStorageController>(),
        ));
    ...
    gh.lazySingleton<_i932.AuthRepository>(
        () => _i932.AuthRepository(gh<_i969.AuthDataSources>()));
    gh.factory<_i141.AuthCubit>(
        () => _i141.AuthCubit(gh<_i932.AuthRepository>()));
