...
class _$NavbarStateImpl extends _NavbarState {
  const _$NavbarStateImpl({required this.selectedIndex}) : super._();
...
abstract class _NavbarState extends NavBarState {
  const factory _NavbarState({required final int selectedIndex}) =
      _$NavbarStateImpl;
